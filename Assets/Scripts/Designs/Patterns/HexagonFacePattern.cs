...
[Serializable]
public struct HexagonFacePattern : IEquatable<HexagonFacePattern>
{
	public bool xflip;
	public bool yflip;
	...
	public HexagonFacePattern(bool xflip, bool yflip, int c0_p, int c1_p, int c2_p, int c3_p, int c4_p, int c5_p, int va, int vb)
	{
		this.xflip = xflip;
		this.yflip = yflip;
		this.c0_p = c0_p;
	...
	public HexagonFacePattern(bool xflip, bool yflip, int c0_p, int c1_p, int c2_p, int c3_p, int c4_p, int c5_p, int c0_cid, int c1_cid, int c2_cid, int c3_cid, int c4_cid, int c5_cid, int va, int vb)
	{
		this.xflip = xflip;
		this.yflip = yflip;
		this.c0_p = c0_p;
	...
	{
		if (!(obj is HexagonFacePattern)) {
			return false;
		}
		return this.Equals((HexagonFacePattern)obj);
	}
	public bool Equals(HexagonFacePattern other)
	{
	...
	public static bool operator ==(HexagonFacePattern pat0, HexagonFacePattern pat1)
	{
	...
	public static HexagonFacePattern empty {
		get {
			return new HexagonFacePattern(false, false, 0, 0, 0, 0, 0, 0, 0, 0);
		}
	}
	...
	public static PatternMatch CalculateTransform(HexagonFacePattern from, HexagonFacePattern to)
	{
