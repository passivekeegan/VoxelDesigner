...
[Serializable]
public struct LateralPattern : IEquatable<LateralPattern>
{
	public bool xflip;
	public bool yflip;
	public int p0, p1;
	...
	public LateralPattern(bool xflip, bool yflip, int p0, int p1, int a0, int b0, int a1, int b1)
	{
		this.xflip = xflip;
		this.yflip = yflip;
		this.p0 = p0;
	...
	public LateralPattern(bool xflip, bool yflip, int p0, int p1, int cid0, int cid1, int a0, int b0, int a1, int b1)
	{
		this.xflip = xflip;
		this.yflip = yflip;
		this.p0 = p0;
	...
	{
		if (!(obj is LateralPattern)) {
			return false;
		}
		return this.Equals((LateralPattern)obj);
	}
	public bool Equals(LateralPattern other)
	{
	...
	public static bool operator ==(LateralPattern pat0, LateralPattern pat1)
	{
	...
	public static LateralPattern empty {
		get {
			return new LateralPattern(false, false, 0, 0, 0, 0, 0, 0);
		}
	}

	public LateralPattern GetPatternCopy(bool keep_cid0, bool keep_cid1)
	{
		int c0 = -1;
		if (keep_cid0) {
			c0 = cid0;
		...
		return new LateralPattern(xflip, yflip, p0, p1, c0, c1, a0, b0, a1, b1);
	}
	...
	public static PatternMatch CalculateTransform(LateralPattern from, LateralPattern to, int d)
	{
