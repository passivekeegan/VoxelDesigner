...
[Serializable]
public struct LongitudePattern : IEquatable<LongitudePattern>
{
	public bool xflip;
	public bool yflip;
	public int p0, p1;
	...
	public LongitudePattern(bool xflip, bool yflip, int p0, int p1, int in0, int out0, int out1)
	{
		this.xflip = xflip;
		this.yflip = yflip;
		this.p0 = p0;
	...
	public LongitudePattern(bool xflip, bool yflip, int p0, int p1, int cid0, int cid1, int in0, int out0, int out1)
	{
		this.xflip = xflip;
		this.yflip = yflip;
		this.p0 = p0;
	...
	{
		if (!(obj is LongitudePattern)) {
			return false;
		}
		return this.Equals((LongitudePattern)obj);
	}
	public bool Equals(LongitudePattern other)
	{
	...
	public static bool operator ==(LongitudePattern pat0, LongitudePattern pat1)
	{
	...
	public static LongitudePattern empty {
		get {
			return new LongitudePattern(false, false, 0, 0, 0, 0, 0);
		}
	}

	public LongitudePattern GetPatternCopy(bool keep_cid0, bool keep_cid1)
	{
		int c0 = -1;
		if (keep_cid0) {
			c0 = cid0;
		...
		return new LongitudePattern(xflip, yflip, p0, p1, c0, c1, in0, out0, out1);
	}
	...
	public static PatternMatch CalculateTransform(LongitudePattern from, LongitudePattern to, bool topheavy)
	{
