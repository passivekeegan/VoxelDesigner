...
public class LongitudeMapPanel : PanelGUI
{
	...
	{
		GUI.Label(rect, "No Longitudes Found.", GUI.skin.GetStyle("RightListLabel"));
	}
	...
	public void UpdatePatternList()
	{
		...
		//fill list
		target.AddLongitudePatternsToList(_edges[index], _patterns);
	}
	...
	private void DrawPatternElement(Rect rect, int index, bool active, bool focus)
	{
		...
		//above voxels
		rect_row = VxlGUI.GetAboveElement(rect_content, 1, VxlGUI.MED_BAR, VxlGUI.SM_SPACE, 0);
		GUI.Label(VxlGUI.GetLeftElement(rect_row, 0, two), "V In:", GUI.skin.GetStyle("LeftDarkLabel"));
		GUI.Label(VxlGUI.GetRightElement(rect_row, 0, two / 2f), _patterns[index].in0.ToString(), GUI.skin.GetStyle("LeftDarkLabel"));
		//below voxels
		rect_row = VxlGUI.GetAboveElement(rect_content, 2, VxlGUI.MED_BAR, VxlGUI.SM_SPACE, 0);
		GUI.Label(VxlGUI.GetLeftElement(rect_row, 0, two), "V Out:", GUI.skin.GetStyle("LeftDarkLabel"));
		GUI.Label(VxlGUI.GetRightElement(rect_row, 1, two / 2f), _patterns[index].out0.ToString(), GUI.skin.GetStyle("LeftDarkLabel"));
		GUI.Label(VxlGUI.GetRightElement(rect_row, 0, two / 2f), _patterns[index].out1.ToString(), GUI.skin.GetStyle("LeftDarkLabel"));
		//flips
		rect_row = VxlGUI.GetAboveElement(rect_content, 3, VxlGUI.MED_BAR, VxlGUI.SM_SPACE, 0);
		GUI.Label(VxlGUI.GetLeftElement(rect_row, 0, two / 2f), "FlipX", GUI.skin.GetStyle("LeftDarkLabel"));
		GUI.Label(VxlGUI.GetLeftElement(rect_row, 0, two / 2f), _patterns[index].xflip.ToString(), GUI.skin.GetStyle("LeftDarkLabel"));
		GUI.Label(VxlGUI.GetLeftElement(rect_row, 0, two / 2f), "FlipY", GUI.skin.GetStyle("LeftDarkLabel"));
		GUI.Label(VxlGUI.GetLeftElement(rect_row, 0, two / 2f), _patterns[index].yflip.ToString(), GUI.skin.GetStyle("LeftDarkLabel"));
	}
	#endregion
}