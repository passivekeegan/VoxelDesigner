...
public abstract class SubModeScreen
{
	protected VoxelMapping _map;
	protected VoxelDesign _design;
	...
	public abstract void Enable(VoxelMapping map, VoxelDesign design);
